...
export interface ApiTollBoothTollBooth extends Schema.CollectionType {
  collectionName: 'toll_booths';
  info: {
    description: '';
    displayName: 'toll_booth';
    pluralName: 'toll-booths';
    singularName: 'toll-booth';
  };
  options: {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::toll-booth.toll-booth': ApiTollBoothTollBooth;
