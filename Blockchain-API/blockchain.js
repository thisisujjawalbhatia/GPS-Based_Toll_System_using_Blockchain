...
const CONTRACT_ADDRESS = '0x3D271A1cB3aaBEf453ff57a8119f168cFfe35fc8';
...
// (async () => {
//     const walletAddress = "0xYourWalletAddressHere"; // Replace with the wallet address
//     try {
//         const balance = await getWalletBalance(walletAddress);
//         console.log(`Balance of ${walletAddress}: ${balance} ETH`);
//     } catch (error) {
